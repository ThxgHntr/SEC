const FIXED_VIETNAMESE_WORD = {
  ...
  PROJECT_PLAN_LINK:
    "https://drive.google.com/file/d/1iJad-6AooZAFskVbaHONQhz24t5LrN0a/view?usp=drive_link",
  ...
  PROJECT1_NAME:
    "DỰ ÁN HỖ TRỢ XÂY DỰNG MÔ HÌNH KINH TẾ VƯỜN Ở LÀNG PÀ CĂNG MỚI CỦA NGƯỜI CƠ TU",
