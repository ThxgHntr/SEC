const FIXED_FRANCAIS_WORD = {
  ...
  PROJECT2: "https://www.youtube.com/embed/d1A8bHeoQOA?si=9ckNZUt-3rGy9BEF",
  PROJECT2_DETAILS:
  ...
  BLOG: "BLOGUES",
  INCOMING_PROJECTS: "PROJETS ENTRANTS",
  COMPLETED_PROJECTS: "PROJETS FINIS",
  ...
  PROJECT1_NAME:
    "PROJET DE CONSTRUCTION D'UN JARDIN DE PLANTES ET D'ÉLEVAGES MODÈLE DE VILLAGE POPULAIRE DE CO TU",
  PROJECT2_NAME:
    "PROJET DE CONSTRUCTION D'UNE USINE DE PRODUCTION D'ENGRAIS ORGANIQUES DANS LE VILLAGE DE PA-CANG DE CO TU",
  PROJECT1_LINK: "/Project1FR.pdf",
  PROJECT2_LINK: "/Project2FR.pdf",
  PROJECT_PLAN_LINK: "/MainProjectPlanFR.pdf",
  PROJECT_MAIN_LINK: "/MainProjectFR.pdf",
  ...
  //Footer
  INFO: "Informations sur la société",
  COMPANY_NAME: "Nom de la société",
  NAME:"Société à but non lucratif Smile Eye Charity (en abrégé Smile Eye Charity)",
  THUE:"N° de registre fiscal",
  STK:"N° de compte",
  TIME: "HORAIRE",
  TIME_DETAIL: "Du lundi au samedi: 8h30-17h30",
  HELP: "24/7 Support",
};

export default FIXED_FRANCAIS_WORD;
